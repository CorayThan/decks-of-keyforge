...
interface DeckSearchValues1Repo : CrudRepository<DeckSearchValues1, Long> {
    ...
    @Query(
        value = """
            ...
            DROP INDEX IF EXISTS dsv1_deck_listed_on_idx;
            ...
            DROP INDEX IF EXISTS dsv1_for_sale_idx;
            DROP INDEX IF EXISTS dsv1_for_trade_idx;
...
interface DeckSearchValues2Repo : CrudRepository<DeckSearchValues2, Long> {
    ...
    @Query(
        value = """
            CREATE INDEX IF NOT EXISTS dsv2_sas_asc_id_idx ON deck_search_values2 (sas_rating, id);
            CREATE INDEX IF NOT EXISTS dsv2_sas_desc_id_idx ON deck_search_values2 (sas_rating DESC, id);
            CREATE INDEX IF NOT EXISTS dsv2_import_date_time_asc_id_idx ON deck_search_values2 (import_date_time, id);
            CREATE INDEX IF NOT EXISTS dsv2_import_date_time_desc_id_idx ON deck_search_values2 (import_date_time DESC, id);
            CREATE INDEX IF NOT EXISTS dsv2_deck_listed_on_idx ON deck_search_values2 (listed_on DESC, id);
            
            CREATE INDEX IF NOT EXISTS dsv2_deck_name_lower ON deck_search_values2 USING gin (LOWER(name) gin_trgm_ops);
            CREATE INDEX IF NOT EXISTS dsv2_expansion_idx ON deck_search_values2 (expansion);
            CREATE INDEX IF NOT EXISTS dsv2_maverick_count_idx ON deck_search_values2 (maverick_count);
            CREATE INDEX IF NOT EXISTS dsv2_raw_amber_idx ON deck_search_values2 (raw_amber);
            CREATE INDEX IF NOT EXISTS dsv2_bonus_draw_idx ON deck_search_values2 (bonus_draw);
            CREATE INDEX IF NOT EXISTS dsv2_bonus_capture_idx ON deck_search_values2 (bonus_capture);
            CREATE INDEX IF NOT EXISTS dsv2_creature_count_idx ON deck_search_values2 (creature_count);
            CREATE INDEX IF NOT EXISTS dsv2_action_count_idx ON deck_search_values2 (action_count);
            CREATE INDEX IF NOT EXISTS dsv2_artifact_count_idx ON deck_search_values2 (artifact_count);
            CREATE INDEX IF NOT EXISTS dsv2_upgrade_count_idx ON deck_search_values2 (upgrade_count);
            CREATE INDEX IF NOT EXISTS dsv2_token_number_idx ON deck_search_values2 (token_number);
            CREATE INDEX IF NOT EXISTS dsv2_card_names_idx ON deck_search_values2 USING gin (card_names gin_trgm_ops);
            CREATE INDEX IF NOT EXISTS dsv2_house_names_string_idx ON deck_search_values2 USING gin (house_names_string gin_trgm_ops);
            
            CREATE INDEX IF NOT EXISTS dsv2_sas_rating_idx ON deck_search_values2 (sas_rating);
            CREATE INDEX IF NOT EXISTS dsv2_synergy_rating_idx ON deck_search_values2 (synergy_rating);
            CREATE INDEX IF NOT EXISTS dsv2_antisynergy_rating_idx ON deck_search_values2 (antisynergy_rating);
            CREATE INDEX IF NOT EXISTS dsv2_amber_control_idx ON deck_search_values2 (amber_control);
            CREATE INDEX IF NOT EXISTS dsv2_expected_amber_idx ON deck_search_values2 (expected_amber);
            CREATE INDEX IF NOT EXISTS dsv2_artifact_control_idx ON deck_search_values2 (artifact_control);
            CREATE INDEX IF NOT EXISTS dsv2_creature_control_idx ON deck_search_values2 (creature_control);
            CREATE INDEX IF NOT EXISTS dsv2_efficiency_idx ON deck_search_values2 (efficiency);
            CREATE INDEX IF NOT EXISTS dsv2_recursion_idx ON deck_search_values2 (recursion);
            CREATE INDEX IF NOT EXISTS dsv2_disruption_idx ON deck_search_values2 (disruption);
            CREATE INDEX IF NOT EXISTS dsv2_effective_power_idx ON deck_search_values2 (effective_power);
            
            CREATE INDEX IF NOT EXISTS dsv2_for_sale_idx ON deck_search_values2 (for_sale);
            CREATE INDEX IF NOT EXISTS dsv2_for_trade_idx ON deck_search_values2 (for_trade);
            
            CREATE INDEX IF NOT EXISTS dsv2_deck_id_idx ON deck_search_values2 (deck_id);
        """,
        nativeQuery = true
    )
    fun addIndexes()
    ...
    @Query(
        value = """
            ...
            DROP INDEX IF EXISTS dsv2_deck_listed_on_idx;
            ...
            DROP INDEX IF EXISTS dsv2_for_sale_idx;
            DROP INDEX IF EXISTS dsv2_for_trade_idx;
