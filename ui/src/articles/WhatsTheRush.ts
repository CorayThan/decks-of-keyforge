            ...
            entries: [
                ...
                },
                {
                    ...
                    listItems: [
                        ...
                        "{{house: Sanctum}} – {{cardName: Vaultkeeper}}, {{cardName: Doorstep to Heaven}}, {{cardName: Numquid the Fair}}",
                        "{{house: Shadows}} – {{cardName: Bait & Switch}}, {{cardName: Miasma}}, {{cardName: Shadow Self}}",
