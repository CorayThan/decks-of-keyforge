...
import randomjoeImg from "../user/imgs/randomjoe.png"
...
export const dunkoro: Author = {
    ...
    img: dunkoroImg,
    bio: [
        "Dunkoro is a member of the SAS-LP team.",
        "He has a long history working with card games, beginning with Magic: the Gathering, playing Yu-Gi-Oh! competitively for a few years and creating the first competitive team in Gwent, which has left a lasting effect on the game as a whole.",
...
export const randomjoe: Author = {
    name: "randomjoe",
    username: "randomjoe",
    img: randomjoeImg,
    bio: [
        "Randomjoe is a member of the SAS-LP team.",
        "He is passionate about rules and the systems that go with them, with a history of professional card game design.",
        "He was excited about Keyforge from early on, and so (like many others) has closely watching rulings and FAQ evolution over time, and has puzzled over how to create internal consistency within those rulings and extend them to new situations not clearly covered by the rules or FAQ answers."
    ]
}
...
export const bigZ: Author = {
    ...
    bio: [
        ...
        "I am also part of the newly formed Team SAS-LP! How SASy is your deck?"
    ]
}
