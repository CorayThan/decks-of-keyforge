...
export class TeamSasLp extends React.Component {
    ...
    render() {
        return (
            <AboutGridItem>
                <InfoListCard title={"Team SAS-LP"} infos={[
                    "Team SAS of the Luxurious Playstyle is a competitive KeyForge team sponsored by Decks of KeyForge and",
                    <a href={"https://luxuryplaystyle.com"} target={"_blank"}>Luxury Playstyle</a>,
                    ...
                    <a href={"https://sites.google.com/view/zforge/team-sas-lp"} target={"_blank"}>Team SAS-LP</a>,
                ]}/>
            </AboutGridItem>
        )
    }
