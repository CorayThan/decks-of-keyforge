        ...
        <SortableTableContainer
            ...
            controls={(
                <Box display={"flex"} alignItems={"center"}>
                    {userStore.loggedIn() && (
                        <LinkButton href={mineOnly ? Routes.tournaments : Routes.myTournaments}
...
const tournamentsTableHeaders = (isAdmin: boolean): SortableTableHeaderInfo<TournamentSearchResult>[] => {
    ...
    const headers: SortableTableHeaderInfo<TournamentSearchResult>[] = [
        ...
        {property: "stage", transform: tournament => Utils.enumNameToReadable(tournament.stage)},
        {
            property: "private",
            title: "Registration",
            transform: tournament => tournament.private ? "Private" : "Public"
        },
        ...
        },
        {
            transform: tournament => (
                <Box display={"flex"}>
                    ...
                    <LinkButton href={Routes.tournamentDecksSearch(tournament.id)} newWindow={true}
                                style={{marginLeft: spacing(2)}}>Decks</LinkButton>
